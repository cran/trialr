...
#include "stanExports_NeuenschwanderTwoParamLogit.h"

RCPP_MODULE(stan_fit4NeuenschwanderTwoParamLogit_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_NeuenschwanderTwoParamLogit")
