...
namespace model_NeuenschwanderTwoParamLogit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_NeuenschwanderTwoParamLogit");
    reader.add_event(110, 108, "end", "model_NeuenschwanderTwoParamLogit");
    return reader;
}
template <typename T2__, typename T3__, typename T4__, typename T5__>
typename boost::math::tools::promote_args<T2__, T3__, T4__, T5__>::type
log_joint_pdf(const int& num_patients,
                  const std::vector<int>& tox,
                  const std::vector<T2__>& codified_doses,
    ...
    try {
        ...
        for (int j = 1; j <= num_patients; ++j) {
            ...
            stan::math::assign(prob_tox, inv_logit((alpha + (stan::math::exp(beta) * get_base1(codified_doses, j, "codified_doses", 1)))));
...
struct log_joint_pdf_functor__ {
    ...
    operator()(const int& num_patients,
        ...
        return log_joint_pdf(num_patients, tox, codified_doses, weights, alpha, beta, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_NeuenschwanderTwoParamLogit
  : public stan::model::model_base_crtp<model_NeuenschwanderTwoParamLogit> {
private:
        double alpha_mean;
        double alpha_sd;
        double beta_mean;
...
public:
    model_NeuenschwanderTwoParamLogit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_NeuenschwanderTwoParamLogit_namespace::model_NeuenschwanderTwoParamLogit";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "d_star", "double", context__.to_vec());
            d_star = double(0);
            vals_r__ = context__.vals_r("d_star");
            pos__ = 0;
            d_star = vals_r__[pos__++];
            check_greater_or_equal(function__, "d_star", d_star, 0);
            ...
            validate_non_negative_index("codified_doses", "num_patients", num_patients);
            codified_doses = std::vector<double>(num_patients, double(0));
            ...
            for (int j = 1; j <= num_patients; ++j) {
                ...
                stan::model::assign(codified_doses, 
                            ...
                            stan::math::log((get_base1(real_doses, get_base1(doses, j, "doses", 1), "real_doses", 1) / d_star)), 
        ...
        try {
            ...
            for (int i = 1; i <= num_doses; ++i) {
                ...
                stan::model::assign(prob_tox, 
                            ...
                            inv_logit((alpha + (stan::math::exp(beta) * stan::math::log((get_base1(real_doses, i, "real_doses", 1) / d_star))))), 
            ...
            lp_accum__.add(log_joint_pdf(num_patients, tox, codified_doses, weights, alpha, beta, pstream__));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_NeuenschwanderTwoParamLogit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int j = 1; j <= num_patients; ++j) {
                ...
                stan::math::assign(p_j, inv_logit((alpha + (stan::math::exp(beta) * get_base1(codified_doses, j, "codified_doses", 1)))));
    ...
    std::string model_name() const {
        return "model_NeuenschwanderTwoParamLogit";
    }
...
typedef model_NeuenschwanderTwoParamLogit_namespace::model_NeuenschwanderTwoParamLogit stan_model;
#ifndef USING_R
